...
برای ‍`read_ahead` نیز هر بار که یک سکتور از دیسک می‌خوانیم و سکتور بعدی را نیز وارد بافرکش می‌کنیم. این کار را نیز بعد از خواندن سکتور به کمک یک ترد انجام می‌دهیم.
