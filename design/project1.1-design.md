...
در صورتی که کل فایل رد یک page باشد با یک بار فراخوانی عملیات انجام می‌شود ولی اگر هر بایت از فایل در یک page متفاوت باشد نیاز داریم ۴۰۹۶ فراخوانی انجام دهیم. بنابراین در این حالت حداقل ۱ و حاکثر ۴۰۹۶ فراخوانی خواهیم داشت.
